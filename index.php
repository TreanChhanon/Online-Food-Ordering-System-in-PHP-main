...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Online Food Ordering System - Trean Chhanon</title>
...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/top2.jpg">
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">Easiest way to order your favourite food among these top 9 dishes</p>
            </div>
            <div class="row">
